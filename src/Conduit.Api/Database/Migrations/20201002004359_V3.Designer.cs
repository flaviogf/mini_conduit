...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Conduit.Api.Models.ArticleComment", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Conduit.Api.Models.UserArticle", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Conduit.Api.Models.ArticleComment", b =>
                {
                    ...
                    b.HasOne("Conduit.Api.Models.User", "User")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Conduit.Api.Models.UserSubscription", b =>
                {
                    b.HasOne("Conduit.Api.Models.User", "Subscriber")
                        .WithMany("Subscriptions")
                        .HasForeignKey("SubscriberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Conduit.Api.Models.User", "Subscription")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Conduit.Api.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
